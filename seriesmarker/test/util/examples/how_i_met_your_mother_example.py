...
class HowIMetYourMotherExample(object):
    ...
    @staticmethod
    def show():
        show = Show(api=None, language=None, data=HowIMetYourMotherExample.series_attributes())
        show.seasons = HowIMetYourMotherExample.seasons(show)
        show.banner_objects = HowIMetYourMotherExample.banners(show)
        show.actor_objects = HowIMetYourMotherExample.roles(show)
        return show

    @staticmethod
    def show_update():
        show = HowIMetYourMotherExample.show()
        show.seasons = HowIMetYourMotherExample.seasons_update(show)
        return show

    @staticmethod
    def series_attributes():
        attributes = {
                    'Actors': ['Josh Radnor', 'Cobie Smulders', 'Neil Patrick Harris', 'Jason Segel', 'Alyson Hannigan', 'Bob Saget'],
    ...
    def seasons(show):
        ...
        episode02 = Episode(attributes, season0)
        ...
        episode14 = Episode(attributes, season1)
        ...
        season1.episodes = {1: episode11, 2: episode12, 3: episode13, 4: episode14}
    ...
    def roles(show):
        ...
        actor2 = Actor(mirror=mirror, data=attributes, show=show)
