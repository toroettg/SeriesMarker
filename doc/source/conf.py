...
for assignment in content:
    exec(assignment)
application_author_name = "Tobias Röttger"
...
latex_documents = [
  ('index', 'SeriesMarker.tex', application_name + " Documentation",
   application_author_name, 'manual'),
]
...
man_pages = [
    ('index', 'seriesmarker', application_name + " Documentation",
     [application_author_name], 1)
]
...
texinfo_documents = [
  ('index', application_name, application_name + " Documentation",  # @UndefinedVariable
   application_author_name, application_name, application_description,  # @UndefinedVariable
   'Miscellaneous'),
]
